...
Pr = 7
Sc = 50/4
delta = 1*(10**-4) # 1*(10**-4) 999999999999999999999999
beta = 4/2.648228  
Re = 1 / nu
SS = L_T / (c_p * T_B)
MM = (em * C_B * C_0) #/ T_B
...
# dt = 1e-3  # Adjust as needed
# solver.stop_iteration = 200 
...
# snapshot_file = 'snapshots/snapshots_s1.h5'
# with h5py.File(snapshot_file, mode='r') as file:
#     Phase_data = file['tasks']['Phase'][:]

# # Create a figure and axis for the animation
# fig, ax = plt.subplots(figsize=(10, 5))
# # Create the initial frame
# im = ax.imshow(np.rot90(Phase_data[0, :, :],k=3), cmap='viridis', origin='lower', aspect='auto')
# ax.set_title("Phase['g']-June 16")

# # Function to update the animation
# def update_frame(i):
#     im.set_data(np.rot90(Phase_data[i, :, :],k=3))
#     return [im]

# # Create the animation
# ani = animation.FuncAnimation(fig, update_frame, frames=Phase_data.shape[0], interval=300, blit=True)
# # Save the animation as a video file using ffmpeg
# ani.save('phase_animation16.mp4', writer='ffmpeg', fps=20)
# plt.show()

# # Load the snapshots from the HDF5 file
# snapshot_file = 'snapshots/snapshots_s1.h5'
# with h5py.File(snapshot_file, mode='r') as file:
#     T_data = file['tasks']['Temperature'][:]

# # Create a figure and axis for the animation
# fig, ax = plt.subplots(figsize=(10, 5))
# # Create the initial frame
# im = ax.imshow(np.rot90(T_data[0, :, :],k=3), cmap='viridis', origin='lower', aspect='auto')
# ax.set_title("Temperature-June 16")

# # Function to update the animation
# def update_frame(i):
#     im.set_data(np.rot90(T_data[i, :, :],k=3))
#     return [im]

# # Create the animation
# ani = animation.FuncAnimation(fig, update_frame, frames=T_data.shape[0], interval=300, blit=True)
# # Save the animation as a video file using ffmpeg
# ani.save('T_animation16.mp4', writer='ffmpeg', fps=20)
# plt.show()

# # Load the snapshots from the HDF5 file
# snapshot_file = 'snapshots/snapshots_s1.h5'
# with h5py.File(snapshot_file, mode='r') as file:
#     b_data = file['tasks']['Temperature'][:]

# # Create a figure and axis for the animation
# fig, ax = plt.subplots(figsize=(10, 5))
# # Create the initial frame
# im = ax.imshow(np.rot90(b_data[0, :, :],k=3), cmap='viridis', origin='lower', aspect='auto')
# ax.set_title('buoyancy-June 16')

# # Function to update the animation
# def update_frame(i):
#     im.set_data(np.rot90(b_data[i, :, :],k=3))
#     return [im]

# # Create the animation
# ani = animation.FuncAnimation(fig, update_frame, frames=b_data.shape[0], interval=300, blit=True)
# # Save the animation as a video file using ffmpeg
# ani.save('buoyancy_animation16.mp4', writer='ffmpeg', fps=20)
# plt.show()
# # Create a figure and axis for the animation
...
# snapshot_file = 'snapshots/snapshots_s1.h5'
# with h5py.File(snapshot_file, mode='r') as file:
#     C_data = file['tasks']['Concentration'][:]

# fig, ax = plt.subplots(figsize=(10, 5))
# # Create the initial frame
# im = ax.imshow(np.rot90(C_data[0, :, :],k=3), cmap='viridis', origin='lower', aspect='auto')
# ax.set_title("Concentration-June 16")

# # Function to update the animation
# def update_frame(i):
#     im.set_data(np.rot90(C_data[i, :, :],k=3))
#     return [im]

# # Create the animation
# ani = animation.FuncAnimation(fig, update_frame, frames=C_data.shape[0], interval=300, blit=True)
# # Save the animation as a video file using ffmpeg
# ani.save('Concentration_animation16.mp4', writer='ffmpeg', fps=20)
# plt.show()
